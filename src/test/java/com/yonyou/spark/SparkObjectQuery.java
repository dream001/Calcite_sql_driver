...
//
//        final String plan = "PLAN=" + "EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }]])";
//
//        final String expectedResult = "EXPR$0=1; EXPR$1=a\n" + "EXPR$0=2; EXPR$1=b\n";
//
//        sql(sql).returns(expectedResult).explainContains(plan);
//    }
//
...
//
//        final String plan =
//                "PLAN=" + "EnumerableCalc(expr#0..1=[{inputs}], expr#2=[2], expr#3=[<($t0, $t2)], proj#0..1=[{exprs}], $condition=[$t3])\n"
...
//
//        final String plan = "PLAN=" + "EnumerableAggregate(group=[{0, 1}])\n"
//                + "  EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n\n";
//
//        final String expectedResult = "X=1; Y=a\n" + "X=1; Y=b\n" + "X=2; Y=b\n" + "X=2; Y=c";
//
//        sql(sql).returnsUnordered(expectedResult).explainContains(plan);
//    }
//
...
//        final String sql = "select *\n" + "from " + VALUES1 + "\n" + " intersect\n" + "select *\n" + "from " + VALUES2;
//
//        final String plan = "PLAN=" + "EnumerableIntersect(all=[false])\n"
//                + "  EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }]])\n"
//                + "  EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n";
//
//        final String expectedResult = "X=1; Y=a\n" + "X=2; Y=b";
...
//
//        final String plan = "PLAN=" + "EnumerableSort(sort0=[$1], dir0=[ASC])\n"
...
//
//        final String plan = "PLAN=" + "EnumerableSort(sort0=[$1], sort1=[$0], dir0=[DESC], dir1=[DESC])\n"
//                + "  EnumerableCalc(expr#0..1=[{inputs}], Y=[$t1], X=[$t0])\n"
//                + "    EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n\n";
//
...
//        final String sql = "select y\n" + "from " + VALUES2 + "\n" + "order by x desc, y";
//
//        final String plan = "PLAN=" + "EnumerableSort(sort0=[$1], sort1=[$0], dir0=[DESC], dir1=[ASC])\n"
//                + "  EnumerableCalc(expr#0..1=[{inputs}], Y=[$t1], X=[$t0])\n"
//                + "    EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n\n";
//
...
//        final String sql = "select y\n" + "from " + VALUES2 + "\n" + "order by x, y desc";
//
//        final String plan = "PLAN=" + "EnumerableSort(sort0=[$1], sort1=[$0], dir0=[ASC], dir1=[DESC])\n"
//                + "  EnumerableCalc(expr#0..1=[{inputs}], Y=[$t1], X=[$t0])\n"
//                + "    EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n\n";
//
//        final String expectedResult = "Y=b\n" + "Y=a\n" + "Y=c\n" + "Y=c\n" + "Y=b\n";
...
//
//        final String plan = "PLAN=" + "EnumerableCalc(expr#0..3=[{inputs}], Y=[$t3], Z=[$t1])\n"
...
//                + VALUES3 + " on t.x = v.w) as r";
//
//        final String plan = "PLAN=" + "EnumerableCalc(expr#0..3=[{inputs}], Z=[$t1])\n"
//                + "  EnumerableJoin(condition=[=($0, $2)], joinType=[inner])\n"
//                + "    EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }]])\n"
//                + "    EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n\n";
//
...
//        final String sql = "select *\n" + "from " + VALUES2 + "\n" + "where x = 1\n" + "limit 1";
//
//        final String plan = "PLAN=" + "EnumerableLimit(fetch=[1])\n"
...
//        final String sql = "select *\n" + "from " + VALUES2 + "\n" + "order by y\n" + "offset 2";
//
//        final String plan = "PLAN=" + "EnumerableLimit(offset=[2])\n"
//                + "  EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n\n";
//
...
//
//        final String plan =
//                "PLAN=" + "EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n\n";
//
//        final String expectedResult = "X=1; Y=a\n" + "X=1; Y=b\n" + "X=2; Y=b\n" + "X=2; Y=c\n" + "X=2; Y=c";
//
//        sql(sql).returnsUnordered(expectedResult).explainContains(plan);
...
//                + "from " + VALUES2 + "\n" + "where x > 1";
//
//        final String plan = "PLAN=" + "EnumerableUnion(all=[true])\n"
//                + "  EnumerableCalc(expr#0..1=[{inputs}], expr#2=[1], expr#3=[>($t0, $t2)], proj#0..1=[{exprs}], $condition=[$t3])\n"
//                + "    EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }]])\n"
//                + "  EnumerableCalc(expr#0..1=[{inputs}], expr#2=[1], expr#3=[>($t0, $t2)], proj#0..1=[{exprs}], $condition=[$t3])\n"
//                + "    EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }, { 1, 'b' }, { 2, 'c' }, { 2, 'c' }]])\n";
...
//                + "from " + VALUES2 + "\n" + "where x > 1";
//
//        final String plan = "PLAN=" + "EnumerableUnion(all=[false])\n"
...
//
//        final String plan =
//                "PLAN=" + "EnumerableCalc(expr#0..1=[{inputs}], expr#2=[1], expr#3=[+($t0, $t2)], expr#4=[>($t3, $t2)], X=[$t0], $condition=[$t4])\n"
//                        + "  EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }]])\n\n";
//
...
//
//        final String plan =
//                "PLAN=" + "EnumerableCalc(expr#0..1=[{inputs}], expr#2=[1], expr#3=[-($t0, $t2)], expr#4=[0], expr#5=[>($t3, $t4)], X=[$t0], $condition=[$t5])\n"
//                        + "  EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }]])\n\n";
//
//        final String expectedResult = "X=2";
//
...
//
//        final String plan =
//                "PLAN=" + "EnumerableCalc(expr#0..1=[{inputs}], expr#2=[*($t0, $t0)], expr#3=[1], expr#4=[>($t2, $t3)], X=[$t0], $condition=[$t4])\n"
//                        + "  EnumerableValues(tuples=[[{ 1, 'a' }, { 2, 'b' }]])\n\n";
//
//        final String expectedResult = "X=2";
//
